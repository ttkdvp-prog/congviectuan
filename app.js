...
function renderActiveTab() {
  ...
  else if (tab === 'thongke') switchStatsSubTab(currentStatsSubTab || 'org');
...
function renderUserStatistics() {
  ...
  if (userList.length === 0) {
    ...
    userList.forEach((u, idx) => {
      ...
      } else if (pct >= 90 && u.overdue === 0) {
        gradeBadge = `<span class="badge-grade grade-a"><i class="fa-solid fa-trophy" style="margin-right:4px;"></i>Xuất sắc (A)</span>`;
      } else if (pct >= 75 && u.overdue <= 1) {
        gradeBadge = `<span class="badge-grade grade-b"><i class="fa-solid fa-star" style="margin-right:4px;"></i>Tốt (B)</span>`;
      } else if (pct >= 50) {
