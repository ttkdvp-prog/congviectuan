  ...
  if (userList.length === 0) {
    ...
    userList.forEach((u, idx) => {
      ...
      if (u.total === 0) {
        ...
        gradeBadge = `<span class="badge-grade grade-b"><i class="fa-solid fa-star" style="margin-right:4px;"></i>Tốt (A)</span>`;
      } else if (pct >= 50) {
        gradeBadge = `<span class="badge-grade grade-c">Hoàn thành (B)</span>`;
      } else {
